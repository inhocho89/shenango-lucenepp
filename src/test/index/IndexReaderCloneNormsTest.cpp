...
public:
    ...
    void doTestNorms(const DirectoryPtr& dir) {
        ...
        verifyIndex(ir);
        modifyNormsForF1(ir);
        IndexReaderPtr irc = std::dynamic_pointer_cast<IndexReader>(ir->clone());
        verifyIndex(irc);

        modifyNormsForF1(irc);

        IndexReaderPtr irc3 = std::dynamic_pointer_cast<IndexReader>(irc->clone());
        verifyIndex(irc3);
...
TEST_F(IndexReaderCloneNormsTest, testNormsClose) {
    ...
    SegmentReaderPtr reader2 = std::dynamic_pointer_cast<SegmentReader>(reader1->clone());
...
TEST_F(IndexReaderCloneNormsTest, testNormsRefCounting) {
    ...
    IndexReaderPtr reader2C = std::dynamic_pointer_cast<IndexReader>(reader1->clone());
    ...
    IndexReaderPtr reader3C = std::dynamic_pointer_cast<IndexReader>(reader2C->clone());
    ...
    IndexReaderPtr reader4C = std::dynamic_pointer_cast<IndexReader>(reader3C->clone());
    ...
    IndexReaderPtr reader5C = std::dynamic_pointer_cast<IndexReader>(reader4C->clone());
